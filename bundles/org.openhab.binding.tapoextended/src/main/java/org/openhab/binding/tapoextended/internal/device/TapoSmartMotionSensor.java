...
/**
 * TAPO Smart-Motion-Sensor-Device.
 *
 * @author Lucas - Initial contribution
 */
@NonNullByDefault
public class TapoSmartMotionSensor extends TapoHubDevice {
    private final Logger logger = LoggerFactory.getLogger(TapoSmartMotionSensor.class);
     ...
     */
    public TapoSmartMotionSensor(Thing thing) {
        super(thing);
    }
