 ...
 */
package org.openhab.binding.tapoextended.internal.constants;
...
public class TapoThingConstants {
    ...
    public static final String DEVICE_HUB_BRIDGE = "hub";
    ...
    public static final ThingTypeUID HUB_BRIDGE_THING_TYPE = new ThingTypeUID(BINDING_ID, DEVICE_HUB_BRIDGE);
    ...
    // events
    public static final String DEVICE_PROPERTY_EVENT = "event";
    public static final String DEVICE_PROPERTY_EVENT_ROTATION_DETAIL = "rotate_deg";
    public static final String DEVICE_PROPERTY_TIMESTAMP = "timestamp";
    ...
    public static final String CHANNEL_EVENT_DETAILS = "eventDetails";
