...
/**
 * TAPO Smart-Button-Device.
 *
 * @author Lucas - Initial contribution
 */
@NonNullByDefault
public class TapoSmartButton extends TapoHubDevice {
    private final Logger logger = LoggerFactory.getLogger(TapoSmartButton.class);
     ...
     */
    public TapoSmartButton(Thing thing) {
        super(thing);
    }
