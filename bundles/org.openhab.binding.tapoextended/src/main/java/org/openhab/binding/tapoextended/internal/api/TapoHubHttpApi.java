...
import org.openhab.binding.tapoextended.internal.helpers.TapoCipher;
 ...
 */
@NonNullByDefault
public class TapoHubHttpApi {
    private final Logger logger = LoggerFactory.getLogger(TapoHubHttpApi.class);
    private final TapoCipher tapoCipher;
    private Gson gson;
    private String token = "";
    private String cookie = "";
    protected final String uid;
    protected final TapoHubHandler bridge;
     ...
     */
    public TapoHubHttpApi(TapoHubHandler bridgeThingHandler) {
        this.bridge = bridgeThingHandler;
        this.tapoCipher = new TapoCipher();
        this.gson = new Gson();
        this.uid = this.bridge.getUID().getAsString();
        String ipAddress = this.bridge.getIpAddress();
